...
if( isset( $_REQUEST['save_settings'] ) ) {
	...
	if(wp_verify_nonce($_REQUEST['w2a_push_submit_post'], 'w2a_push')){
		...
		if( isset( $settings['w2a_engage_enable'] ) ) {
			$w2a_engage_enable = 1;
		}
		...
		$w2a_settings = array(
			...
			'w2a_engage_enable' => $w2a_engage_enable,
		...
		<div class="my-section" style="margin-top:20px;">
			...
			<table class="form-table">
				<tbody>
					...
					<tr>
						<th scope="row">
							<label for="w2a_disable_web_push"><?php _e('Disable Web Push', 'web2application'); ?></label>
						</th>
						<td>
				
							<input type="checkbox" name="w2a_settings[w2a_disable_web_push]" id="w2a_disable_web_push" value="1"
								<?php if (isset($w2a_options['w2a_disable_web_push']) && $w2a_options['w2a_disable_web_push'] == "1") echo 'checked="checked"'; ?>
								<?php if ('') echo 'disabled="disabled"'; ?> />
							<p class="description"><?php _e('This will turn off the web push usage', 'web2application'); ?></p>
							<?php //echo "check: ".$w2a_options['w2a_disable_web_push']; ?>
						</td>						
					</tr>
		...
		<div class="my-section" style="margin-top:20px;">
			...
			<table class="form-table">
				<tbody>
					...
					<tr>
						<th scope="row">
							<label for="w2a_enable_search_widget"><?php _e('Enable Search Widget', 'web2application'); ?></label>
						</th>
						<td>
							<input type="checkbox" name="w2a_settings[w2a_enable_search_widget]" id="w2a_enable_search_widget" value="1"
								<?php if (isset($w2a_options['w2a_enable_search_widget']) && $w2a_options['w2a_enable_search_widget'] == "1") echo 'checked="checked"'; ?>
								<?php if ($disabled) echo 'disabled="disabled"'; ?> />
							<p class="description"><?php _e('This will turn on the search widget', 'web2application'); ?></p>
							<?php //echo "check: ".$w2a_options['w2a_enable_search_widget']; ?>
						</td>						
					</tr>
					
					<tr>
						<th scope="row">
							<label for="w2a_enable_search_widget_rtl"><?php _e('Enable Search Widget as RTL', 'web2application'); ?></label>
						</th>
						<td>
							<input type="checkbox" name="w2a_settings[w2a_enable_search_widget_rtl]" id="w2a_enable_search_widget_rtl" value="1"
								<?php if (isset($w2a_options['w2a_enable_search_widget_rtl']) && $w2a_options['w2a_enable_search_widget_rtl'] == "1") echo 'checked="checked"'; ?>
								<?php if ($disabled) echo 'disabled="disabled"'; ?> />
							<p class="description"><?php _e('This will turn on the search widget as RTL', 'web2application'); ?></p>
							<?php //echo "check: ".$w2a_options['w2a_enable_search_widget_rtl']; ?>
						</td>						
					</tr>
				
					<tr>
						<th scope="row">
							<label for="w2a_engage_enable"><?php _e('Enable Engage', 'web2application'); ?></label>
						</th>
						<td>
							<input type="checkbox" name="w2a_settings[w2a_engage_enable]" id="w2a_engage_enable" value="1"
								<?php if (isset($w2a_options['w2a_engage_enable']) && $w2a_options['w2a_engage_enable'] == "1") echo 'checked="checked"'; ?>
								<?php if ($disabled) echo 'disabled="disabled"'; ?> />
							<p class="description"><?php _e('Enable Engage', 'web2application'); ?></p>
							<?php //echo "check: ".$w2a_options['w2a_engage_enable']; ?>
						</td>						
					</tr>
...
<?php
// check if the abandon cart table exist
